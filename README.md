...
[![Actions status](https://www.github.com/photocyte/copier-python-package-template/actions/workflows/ci.yaml/badge.svg?branch=main)](https://www.github.com/photocyte/copier-python-package-template/actions)
...
# Provenance
Forked from https://github.com/LabAutomationAndScreening/copier-python-package-template , for my own bespoke needs & learning.
...
1. Run copier to instantiate the template: `copier copy --trust gh:photocyte/copier-python-package-template.git .`
